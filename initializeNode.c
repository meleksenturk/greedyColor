...
// void sendUpdatedArray() {
//   // Implement the logic to send the updated array to other nodes
//   // You can use nullnet_buf and nullnet_len to send the data
//   // Example:
//   // memcpy(nullnet_buf, colorAndValue, colorArraySize * sizeof(struct NodeColor));
//   // nullnet_len = colorArraySize * sizeof(struct NodeColor);
...
PROCESS_THREAD(nullnet_example_process, ev, data) {
  ...
  while (1) {
    ...
    // Wait for a packet to arrive before sending the next one
